<div class="modal fade" id="modaldetail" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content modal-lg">
            ...
            <?= form_open_multipart('admin/order/updateOrder', ['class' => 'formdetailorder']); ?>
            <?= csrf_field(); ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" name='status_id' disabled>
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" name='order_payment_method' disabled>
                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" name='order_payment' disabled>
                        <option class="box" disabled>-- Pilih Metode Pembayaran --</option>
